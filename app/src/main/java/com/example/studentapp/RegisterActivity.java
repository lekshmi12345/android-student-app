...
public class RegisterActivity extends AppCompatActivity {
    ...
    String getname, getrollno, getadmno, getuname, getpass, getcpass, getreg, getgtlog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2 = (AppCompatButton) findViewById(R.id.gtlog);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getpass.equals(getcpass)) {
                    ...
                    Toast.makeText(getApplicationContext(), "password and confirmpassword doen't match", Toast.LENGTH_SHORT).show();
                }
